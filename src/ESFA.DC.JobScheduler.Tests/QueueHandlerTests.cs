...
//            var task = queueHandler.MoveFileUploadJobForProcessing(null).ConfigureAwait(true);
...
//            var task = queueHandler.MoveFileUploadJobForProcessing(job).ConfigureAwait(true);
